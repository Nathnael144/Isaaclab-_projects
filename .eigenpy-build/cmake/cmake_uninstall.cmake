...
IF(NOT EXISTS "/home/nathan/IsaacLab/.eigenpy-build/install_manifest.txt")
  RETURN()
ENDIF(NOT EXISTS "/home/nathan/IsaacLab/.eigenpy-build/install_manifest.txt")

MESSAGE(STATUS "catkin path: /home/nathan/IsaacLab/.eigenpy-install/.catkin")
IF(EXISTS "/home/nathan/IsaacLab/.eigenpy-install/.catkin" AND PACKAGE_CREATES_DOT_CATKIN)
  MESSAGE(STATUS "Try to remove /home/nathan/IsaacLab/.eigenpy-install/.catkin")
  EXECUTE_PROCESS(
      COMMAND ${CMAKE_COMMAND} -E remove "/home/nathan/IsaacLab/.eigenpy-install/.catkin"
...
IF(EXISTS "/install_manifest.txt")
  return()
ENDIF()
FILE(READ "/home/nathan/IsaacLab/.eigenpy-build/install_manifest.txt" files)
STRING(REPLACE "\n" ";" files "${files}")
...
ENDFOREACH(file)
EXECUTE_PROCESS(
  COMMAND ${CMAKE_COMMAND} -E remove "/home/nathan/IsaacLab/.eigenpy-build/install_manifest.txt"
  RESULT_VARIABLE rm_resval
  OUTPUT_VARIABLE rm_out
  ERROR_QUIET
  )
