"""
Downloaded from Unitree official repo:
  unitreerobotics/unitree_rl_mjlab (MuJoCo-based Unitree RL)

Source:
  https://raw.githubusercontent.com/unitreerobotics/unitree_rl_mjlab/main/scripts/train.py
"""

# NOTE: This script targets the unitree_rl_mjlab codebase (mjlab.*), not Isaac Sim / IsaacLab.
# It is provided here for reference/porting.
